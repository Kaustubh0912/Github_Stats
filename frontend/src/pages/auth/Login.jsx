...
function Login() {
  ...
  const handleLoginClick = () => {
    ...
    window.location.href =
      "https://github-stats-1.onrender.com/api/auth/github";
  };
              ...
              <div className="mb-6 p-4 bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-200 rounded-md w-full">
                ...
                <div className="flex flex-col space-y-2">
                  <div className="bg-white/50 dark:bg-gray-800/50 p-2 rounded flex items-center">
                    <span className="font-mono bg-green-200 dark:bg-green-800 px-2 py-1 rounded mr-2">
                      5,000
                    </span>
                    <span>API requests per hour (increased from 60)</span>
                  </div>
                  <p className="text-sm">
                    Your widgets will now use your GitHub authentication token
                    for all API requests, giving you higher rate limits and
